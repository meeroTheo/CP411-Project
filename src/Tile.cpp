...
Tile::Tile()
{
	...
	vertex[2][0] = 2;    vertex[2][1] = 1.5;  vertex[2][2] = 0.3;
	vertex[3][0] = -2;   vertex[3][1] = 1.5;  vertex[3][2] = 0.3;
	vertex[4][0] = -2;   vertex[4][1] = -1.5; vertex[4][2] = 0.3;
	vertex[5][0] = 2;    vertex[5][1] = -1.5; vertex[5][2] = 0.3;
	vertex[6][0] = 2;    vertex[6][1] = 1.5;  vertex[6][2] = 0.3;
	vertex[7][0] = -2;   vertex[7][1] = 1.5;  vertex[7][2] = 0.3;
